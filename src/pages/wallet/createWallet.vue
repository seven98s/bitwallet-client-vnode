...
const createWallet = async () => {
	UniUtil.loadShow();
	const { name, password, rePassword, tips } = param.createWallet;
	let nameTmp = name;
	...
	if (WalletData.existsWalletMnemonic()) {
		...
		uni.setStorageSync(STORAGE_TYPE.MNEMONIC_TEMP_INFO, { name: nameTmp, index: param.placeholderIndex });

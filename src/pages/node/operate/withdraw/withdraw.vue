...
onShow(async () => {
	UniUtil.loadShow();
	show.reward = (await BitInstance.bitweb.trx.getUnconfirmedReward(WalletData.account.address)).toString();
	show.reward = BitInstance.bitweb.fromBit(parseInt(show.reward)).toString();

	const totalWithdrawRs: any = await BitAccount.getTotalWithdraw(WalletData.account.address);
	show.totalReward = totalWithdrawRs.data;
	show.totalReward = BitInstance.bitweb.fromBit(parseInt(show.totalReward)).toString();
	show.totalReward = (parseFloat(show.totalReward) + parseFloat(show.reward)).toString();

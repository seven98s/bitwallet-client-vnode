<template>
	<view class="passwordPopup" v-show="$store.state.passwordPopConfig.show">
		<view class="popup" @click="close"></view>
		<view class="popupContainer">
			<view class="passwordBox">
				<view class="header">
					{{ $store.state.passwordPopConfig.title !== '' ? $store.state.passwordPopConfig.title : '签名交易' }}
				</view>
				<view class="divider">
	...
	export default Vue.extend({
		...
		methods: {
			...
			async confirm(password : string) {
				this.param.password = '';
				await this.$store.state.passwordPopConfig.confirm(password);
			}
		}
	});
</script>

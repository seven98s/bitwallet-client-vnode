<template>
	<view class="navigationBar">
		<view class="nodeBox">
			<image src="@/static/newUI3/index/nodeIcon2.png" mode="scaleToFill" class="nodeIcon"
				@click="gotoPage('/pages/my/setNode')"></image>
		...
		<view class="methodsBox">
			...
			<view class="notice" @click="gotoPage('/pages/node/operate/messageCenter')">
				<image src="@/static/newUI3/index/newsTips.png" class="newsTips" v-if="MessageStore.hasNewMessage">
				</image>
			</view>
			<!-- <image src="@/static/newUI3/index/notice.png" mode="heightFix" class="methodsIcon" @click="showToast('消息提示功能')"></image> -->
		</view>
	</view>
</template>
...
const confirm = () => {
	if (url.value.length > 0) {
		uni.navigateTo({
			url: `/pages/explore/dapp?url=${url.value}`
		});
	}
};
...
.navigationBar {
	...
	.methodsBox {
		...
		.notice {
			...
			width: 34rpx;
			height: 39rpx;
			background-image: url('@/static/newUI3/index/notice.png');
